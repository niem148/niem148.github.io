...
### **IT Troubleshooting & Scenario Documentation**
Available at: **https://niem148.github.io**

Examples include:
- Diagnosing Wi-Fi anomalies & MAC randomisation
- Router band-splitting & device prioritisation
...
- Operated and maintained large-format printers, diagnosing mechanical and software issues
- Prepared print-ready files and ensured colour accuracy and output consistency
...
- Produced high-quality visuals while maintaining stable workstation performance
- Collaborated with multidisciplinary teams, supporting digital workflows and resolving technical issues
...
- PC hardware building & diagnostics
- Raspberry Pi 5 setup & configuration
- Microsoft 365
- Remote support tools & ticketing workflows
- Unreal Engine, 3ds Max, V-Ray
- Photoshop, AutoCAD, SketchUp
- Twinmotion, Lumion
